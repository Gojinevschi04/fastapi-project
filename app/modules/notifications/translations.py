...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "scheduled_body": ("Your call has been scheduled and will be executed automatically."),
        "scheduled_followup": ("You will receive another email when the call is completed."),
        "welcome_title": "Welcome aboard!",
        "welcome_body": ("Welcome to <strong>Quiet Call AI</strong>! Your account is ready."),
        "welcome_body2": (
        ...
        "reset_note": ("If you did not request this, you can safely ignore this email. The link expires in 1 hour."),
        ...
        "email_changed_warning": ("If you did not make this change, please contact support immediately."),
    },
    "ru": {
        "call_completed": "Звонок завершён",
        "call_failed": "Звонок не удался",
        "call_scheduled": "Звонок запланирован",
        "call_completed_body": ("Ваш автоматический звонок был успешно завершён."),
        "call_failed_body": ("Ваш автоматический звонок не удалось завершить."),
        ...
        "scheduled_body": ("Ваш звонок запланирован и будет выполнен автоматически."),
        "scheduled_followup": ("Вы получите ещё одно письмо, когда звонок будет завершён."),
        "welcome_title": "Добро пожаловать!",
        "welcome_body": ("Добро пожаловать в <strong>Quiet Call AI</strong>! Ваш аккаунт готов."),
        "welcome_body2": (
        ...
        "reset_body": ("Мы получили запрос на сброс пароля. Нажмите кнопку ниже, чтобы выбрать новый."),
        "reset_button": "Сбросить пароль",
        "reset_note": ("Если вы не запрашивали это, просто проигнорируйте письмо. Ссылка действительна 1 час."),
        "password_changed_title": "Пароль изменён",
        "password_changed_body": "Ваш пароль был успешно изменён.",
        "password_changed_warning": ("Если вы не делали этого, немедленно сбросьте пароль или свяжитесь с поддержкой."),
        "email_changed_title": "Email изменён",
        "email_changed_body": "Email вашего аккаунта был изменён на",
        "email_changed_warning": ("Если вы не делали этого, немедленно свяжитесь с поддержкой."),
    },
    "ro": {
        "call_completed": "Apel finalizat",
        "call_failed": "Apel eșuat",
        "call_scheduled": "Apel programat",
        "call_completed_body": ("Apelul tău automatizat a fost finalizat cu succes."),
        "call_failed_body": ("Apelul tău automatizat nu a putut fi finalizat."),
        ...
        "scheduled_body": ("Apelul tău a fost programat și va fi executat automat."),
        "scheduled_followup": ("Vei primi un alt email când apelul va fi finalizat."),
        "welcome_title": "Bine ai venit!",
        "welcome_body": ("Bine ai venit la <strong>Quiet Call AI</strong>! Contul tău este gata."),
        "welcome_body2": (
        ...
        "reset_body": ("Am primit o cerere de resetare a parolei. Apasă butonul de mai jos pentru a alege una nouă."),
        "reset_button": "Resetează parola",
        "reset_note": ("Dacă nu ai solicitat acest lucru, poți ignora acest email. Linkul expiră în 1 oră."),
        "password_changed_title": "Parola a fost schimbată",
        "password_changed_body": "Parola ta a fost schimbată cu succes.",
        "password_changed_warning": (
            "Dacă nu ai făcut această modificare, resetează-ți parola imediat sau contactează suportul."
        ),
        "email_changed_title": "Email-ul a fost schimbat",
        "email_changed_body": "Email-ul contului tău a fost schimbat la",
        "email_changed_warning": ("Dacă nu ai făcut această modificare, contactează suportul imediat."),
    },
}
